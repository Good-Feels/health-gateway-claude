...
description: Use A Good Sign to summarize, compare, or interpret the user's synced Apple Health activity, workout, sleep, heart-rate, HRV, energy, and body-mass data.
---

# A Good Sign insights

Use the A Good Sign MCP tools when the user asks about their synced Apple
Health history.
